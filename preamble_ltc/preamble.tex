...
%\usepackage{pdfpages}				% сторонние pdf
...
\newcommand{\CourseName}{Саша пытается восстановиться}
\newcommand{\FullCourseNameFirstPart}{\so{САША ДУРАНЧЕЛУС ПЫТАЕТСЯ ВОССТАНОВИТЬСЯ В МФТИ}}
